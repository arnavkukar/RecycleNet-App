...
const styles = StyleSheet.create({
  ...
  darkText: { color: '#fff' },
  header: { color: config.PRIMARY_ACCENT, fontWeight: '423', fontSize: 40, alignSelf: 'center', marginTop: 1 },
  ...
  impactHeader: { fontSize: 22, fontWeight: '423', color: config.PRIMARY_ACCENT, textAlign: 'center', marginBottom: 3, marginTop: 8 },
  ...
  darkText: { color: '#ddd' },
  impactValue: { fontSize: 16, fontWeight: '423', color: config.PRIMARY_ACCENT },
  ...
  zonestatusText: { color: '#fff', fontSize: 16, fontWeight: '423', marginLeft: '27%'},
  ...
  addzoneText: { color: '#fff', fontSize: 16, fontWeight: '423', marginLeft: '38%'},
  ...
  modalHeader: {color: '#000', fontWeight: '423', fontSize: 30},
