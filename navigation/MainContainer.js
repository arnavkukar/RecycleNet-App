...
//   const TabScreens = () => (
//     <Tab.Navigator>
//       <Tab.Screen name="Test" component={() => <Text>Test Screen</Text>} />
//     </Tab.Navigator>
//   );
...
function DummyTabScreen() {
  return <Text>This is a Tab Screen</Text>;
}
    ...
    <SafeAreaView style={{ flex: 1 }}>
      <NavigationContainer>
        <Tab.Navigator screenOptions={screenOptions}>
          ...
          <Tab.Screen name="Settings">
            {(props) => <Settings {...props} isDarkMode={isDarkMode} />}
          </Tab.Screen>
          <Tab.Screen name="Badges" component={DummyTabScreen} />
          <Tab.Screen name="My Zones" component={DummyTabScreen} />
        </Tab.Navigator>
